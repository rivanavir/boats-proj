...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.setItem = function(n) {
        ...
        if (this.options.infiniteScroll) {
            ...
            } else if (this.options.visibleItems == 7) {
                sliderItems.eq(this._wrapIndex(n - 2)).removeClass().addClass("previous_hidden_3");
                sliderItems.eq(this._wrapIndex(n + 2)).removeClass().addClass("next_item_3");

                sliderItems.eq(this._wrapIndex(n - 3)).removeClass().addClass("previous_item_2");
                sliderItems.eq(this._wrapIndex(n + 3)).removeClass().addClass("next_item_2");

                sliderItems.eq(this._wrapIndex(n - 4)).removeClass().addClass("previous_hidden");
                sliderItems.eq(this._wrapIndex(n + 4)).removeClass().addClass("next_hidden");
            ...
            if (this.options.visibleItems == 7) {
                if (n - 3 >= 0)
                    sliderItems.eq(n - 2).removeClass().addClass("previous_item_3");
                if (n + 3 < this.numSliderItems)
                    sliderItems.eq(n + 2).removeClass().addClass("next_item_3");
